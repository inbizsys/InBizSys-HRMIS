    ...
    <div class="flex-1 px-3 py-4 overflow-y-auto custom-scrollbar">
        ...
        <nav class="space-y-4">
            ...
            <div x-data="{ orgOpen: {{ request()->routeIs('settings.*') ? 'true' : 'false' }} }">
                ...
                <h3 class="px-4 text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2">Employee Management</h3>
                ...
                <div class="space-y-1">
                    ...
                    <div
                        ...
                        {{-- Add Employee --}}
                        <x-sidebar.nav-item
                            href="{{ route('employees.manage') }}"
                            :active="request()->routeIs('employees.manage')"
                            wire:navigate>
                            <x-slot name="icon">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
            ...
            <div x-data="{ orgOpen: {{ request()->routeIs('payroll.*') ? 'true' : 'false' }} }">

                <h3 class="px-4 text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2">Payroll Management</h3>
                ...
                <div class="space-y-1">
                    ...
                    <div
                        ...
                        {{-- 1. Salary Components --}}
                        <x-sidebar.nav-item
                            href="{{ route('payroll.salary-components') }}"
                            :active="request()->routeIs('payroll.salary-components')"
                            wire:navigate>
                            <x-slot name="icon">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                        ...
                        {{--2. Banks Button/Link --}}
                        <x-sidebar.nav-item
                            href="{{ route('payroll.banks') }}"
                            :active="request()->routeIs('payroll.banks')"
                            wire:navigate>
                            <x-slot name="icon">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                        d="M12 21v-8.25M3.75 21h16.5M4.5 9h15M5.25 9v12m13.5-12v12m-9.75-12h6c.414 0 .75-.336.75-.75V3.75c0-.414-.336-.75-.75-.75h-6c-.414 0-.75.336-.75.75v4.5c0 .414.336.75.75.75Z" />
                                </svg>
                            </x-slot>
                            Banks
                        </x-sidebar.nav-item>

                        {{-- 3. Bank Branches Button/Link --}}
                        <x-sidebar.nav-item
                            href="{{ route('payroll.branches') }}"
                            :active="request()->routeIs('payroll.branches')"
                            wire:navigate>
                            <x-slot name="icon">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                        d="M18 18.75a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0ZM9 18.75a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0ZM13.5 5.25a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Zm-3 1.5 3 3.75m-3-3.75-4.5 4.5M13.5 10.5l3 3.75" />
                                </svg>
                            </x-slot>
                            Bank Branches
                        </x-sidebar.nav-item>
