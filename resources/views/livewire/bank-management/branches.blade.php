    ...
    <div class="w-full py-6 px-6">
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-0.5">{{ $bank->bank_name }}</p>
                </div>
            </div>
            <div class="flex gap-2">
                {{-- <button type="button" wire:click="confirmDeleteBank"
                    class="inline-flex items-center gap-1.5 bg-red-50 hover:bg-red-100 text-red-600 text-sm font-medium px-4 py-2 rounded-lg transition-colors">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                    </svg>
                    Delete Bank
                </button> --}}
                <button type="button" wire:click="openBranchModal"
            ...
            <table class="w-full text-sm text-left">
                <thead>
                    <tr class="border-b border-gray-200 bg-gray-50">
                        <th class="px-6 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Branch Code</th>
                        <th class="px-6 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Branch Name</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($branches as $branch)
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-semibold bg-gray-100 text-gray-700 font-mono tracking-wide border border-gray-200">
                                    {{ $branch->branch_code }}
                                </span>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-end gap-4">
                                    ...
                                    <button type="button" wire:click="confirmDeleteBranch({{ $branch->id }})"
        ...
        @if ($showBranchModal)
            <div class="absolute inset-0 z-50 flex items-center justify-center bg-black/50 p-4" x-data
                x-on:keydown.escape.window="$wire.closeBranchModal()">
                <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md flex flex-col overflow-hidden">
                    <div class="flex items-center justify-between px-6 py-5 border-b border-gray-200">
                        ...
                        <button type="button" wire:click="closeBranchModal"
                    ...
                    <div class="px-6 py-5 space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">
                                ...
                                <span class="text-xs font-normal text-gray-400 ml-1">e.g. BOC-001</span>
                            </label>
                            <input type="text" wire:model="branchCode"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm uppercase font-mono tracking-wide focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('branchCode') border-red-400 @enderror"
                                placeholder="e.g. BOC-001"
                                maxlength="20">
                            @error('branchCode')
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="branchName"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('branchName') border-red-400 @enderror"
                        ...
                        <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                            <div class="flex items-center gap-2.5">
                                <input type="checkbox" id="branchIsActive" wire:model="branchIsActive"
                                    class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500 cursor-pointer">
                                <label for="branchIsActive" class="text-sm font-medium text-gray-700 cursor-pointer">
                                    Active
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center justify-between px-6 py-4 border-t border-gray-200 bg-gray-50">
                        ...
                        <div class="flex gap-3">
                            ...
                            <button type="button" wire:click="saveBranch" wire:loading.attr="disabled"
                                ...
                                <span wire:loading wire:target="saveBranch">
            ...
            <div class="fixed inset-0 z-[60] flex items-center justify-center bg-black/50">
                <div class="bg-white rounded-xl shadow-2xl max-w-md mx-4 p-6">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <h3 class="text-base font-semibold text-gray-800">Delete Branch?</h3>
                    </div>
                    <p class="text-sm text-gray-500 mb-5">This action cannot be undone.</p>
                    <div class="flex gap-3 justify-end">
                        <button type="button" wire:click="cancelDeleteBranch"
                            class="border border-gray-300 text-gray-700 text-sm px-5 py-2 rounded-lg hover:bg-gray-100 transition-colors">
                            Cancel
                        </button>
                        <button type="button" wire:click="deleteBranch"
                            class="bg-red-600 hover:bg-red-700 text-white text-sm px-5 py-2 rounded-lg transition-colors">
                            Delete
                        </button>
                    </div>
